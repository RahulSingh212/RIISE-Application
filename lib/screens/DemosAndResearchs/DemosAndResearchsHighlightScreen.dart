...
class DemosAndResearchHighlightScreen extends StatefulWidget {
  ...
  @override
  State<DemosAndResearchHighlightScreen> createState() => _DemosAndResearchHighlightScreenState();
}

class _DemosAndResearchHighlightScreenState extends State<DemosAndResearchHighlightScreen> {

  loadData() async {
    await Provider.of<EventProvider>(context, listen: false).fetchEventTracks(context, "DemosAndResearchesHighlights").then((value){
      setState(() {
