...
class StartUpShowcaseScreen extends StatefulWidget {
  static const routeName = '/rise-start-up-showcase-screen';
  ...
  loadData() async {
    await Provider.of<EventProvider>(context, listen: false)
      ...
      setState(() {
        isLoading = false;
        print(
            "HEllo this is length of RND LIST -> ${Provider.of<EventProvider>(context, listen: false).startUpShowcaseList.length}");
      });
