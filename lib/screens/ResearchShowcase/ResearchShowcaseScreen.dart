...
class ResearchShowcaseScreen extends StatefulWidget {
  static const routeName = '/rise-research-showcase-screen';

  const ResearchShowcaseScreen({super.key});

  @override
  State<ResearchShowcaseScreen> createState() => _ResearchShowcaseScreenState();
}

class _ResearchShowcaseScreenState extends State<ResearchShowcaseScreen> {

  loadData() async {
    await Provider.of<EventProvider>(context, listen: false).fetchEventTracks(context, "ResearchShowcases").then((value){
      setState(() {
